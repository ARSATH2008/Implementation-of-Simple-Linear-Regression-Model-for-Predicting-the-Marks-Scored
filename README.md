...
## Algorithm
1. Import required Python libraries and create the dataset with study hours (input) and marks (output).
...
## Output:
<img width="883" height="671" alt="image" src="https://github.com/user-attachments/assets/2a9d1f0f-ede1-459f-abf6-98049269c295" />
